...
\newcommand{\translatedtitle}{Titel der Arbeit} % Translated title of the thesis.
...
\settitle{\thesistitle}{\translatedtitle} % Sets English and German version of the title (both can be English or German). If your title contains commas, enclose it with additional curvy brackets (i.e., {{your title}}) or define it as a macro as done with \thesistitle.
